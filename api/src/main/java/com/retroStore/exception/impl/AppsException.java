...
import com.retroStore.exception.BaseException;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;

import static com.retroStore.common.constant.AppsConstants.ResponseStatus;

public class AppsException extends Exception implements Serializable, BaseException {
    private static final long serialVersionUID = 4602766942036284722L;
