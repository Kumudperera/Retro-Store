package com.retroStore.service.common;
...
public class AzureStorageService {
    ...
    public String uploadFile(MultipartFile multipartFile, String fileName, DomainConstants.UploadFileType uploadFileType, CredentialsDTO credentialsDTO) throws AppsException {
        LOG.info("START : Azure file upload : {} by user : {}", fileName, credentialsDTO.getUserID());
        String fileUrl = "";
        String filePath = "";
        try {
            ...
            throw new AppsException(RetroStoreErrorCode.APPS_EXCEPTION_FILE_UPLOAD_FAILED);
        }

        LOG.info("END : Azure file upload : {} by user : {}", fileName, credentialsDTO.getUserID());
        return fileUrl;
    }
    ...
    public byte[] downloadFile(String key, CredentialsDTO credentialsDTO) throws AppsException {
        LOG.info("START : Azure file download : {} by user : {}", key, credentialsDTO.getUserID());
        byte[] bytes;
        try {
            ...
            LOG.error("Error : Azure file download : {} by user : {} failed", key, credentialsDTO.getUserID(), e);
            throw new AppsException(RetroStoreErrorCode.APPS_EXCEPTION_FILE_DOWNLOAD_FAILED, e);
        }
        LOG.info("END : Azure file download : {} by user : {}", key, credentialsDTO.getUserID());
