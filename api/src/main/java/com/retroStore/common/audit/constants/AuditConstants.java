package com.retroStore.common.audit.constants;
...
public class AuditConstants {
    ...
    public enum SystemAuditCategory {
        COMPANY("Company"),
        ROADMAP_CONFIGURATION("Road Map Configuration"),
        SETTING("SETTING");
    ...
    public enum SystemAuditTemplate {
        ...
        COMPANY_ADD("Company Add", SystemAuditActionCode.ADD, SystemAuditCategory.COMPANY, SystemAuditSubCategory.COMPANY);
