...
public class EmailService {
    ...
    public void sendMail(EmailSendRequest request, CredentialsDTO credentialDTO) throws AppsException {
        boolean isSendingMailActivated = Boolean.valueOf(appsProperties.getIsSendingMailActivated());
            ...
            try {
                ...
                if (request.getSendType() == DomainConstants.EmailSendType.TEXT) {
                    ...
                    if (StringUtils.isNotEmpty(request.getTemplateName())) {
                        String templatePath = this.appsProperties.getTemplatePath() + File.separator + "text" + File.separator + request.getTemplateName() + ".text";
