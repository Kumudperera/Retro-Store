...
import com.teamx.retroStore.dto.common.CurrencyMathContext;
...
public class DecimalCalculator {
    ...
    public static BigDecimal getDefaultRoundValue(BigDecimal value) {
        return round(value, getDefaultCurrencyMathContext());
    }
